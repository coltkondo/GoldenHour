...
export const venuesApi = {
  ...
  create: (data: VenueCreate) => request<Venue>('/venues/', { method: 'POST', body: JSON.stringify(data) }),
  update: (id: string, data: VenueUpdate) => request<Venue>(`/venues/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const dealsApi = {
  ...
  create: (data: DealCreate) => request<Deal>('/deals/', { method: 'POST', body: JSON.stringify(data) }),
  update: (id: string, data: DealUpdate) => request<Deal>(`/deals/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const submissionsApi = {
  ...
  review: (id: string, action: ReviewAction) =>
    request<Submission>(`/submissions/${id}/review`, { method: 'PATCH', body: JSON.stringify(action) }),
}
