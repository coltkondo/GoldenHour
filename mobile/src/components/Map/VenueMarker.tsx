...
const BarIcon = ({ color }: { color: string }) => (
  <Svg width={14} height={14} viewBox="0 0 24 24" fill="none">
    <Path d="M17 11h2a3 3 0 010 6h-2" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M7 8h10v11a2 2 0 01-2 2H9a2 2 0 01-2-2V8z" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M7 8V6a1 1 0 011-1h4a1 1 0 011 1v2" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

const FoodIcon = ({ color }: { color: string }) => (
  <Svg width={14} height={14} viewBox="0 0 24 24" fill="none">
    <Path d="M18 8h1a4 4 0 010 8h-1M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8z" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
...
const WineIcon = ({ color }: { color: string }) => (
  <Svg width={14} height={14} viewBox="0 0 24 24" fill="none">
    <Path d="M8 3h8M6 3h12a2 2 0 012 2v4c0 3-2 5-4 7v4a2 2 0 01-2 2h0a2 2 0 01-2-2v-4c-2-2-4-4-4-7V5a2 2 0 012-2z" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

const CocktailIcon = ({ color }: { color: string }) => (
  <Svg width={14} height={14} viewBox="0 0 24 24" fill="none">
    <Path d="M8 3l8 8-4 9-4-9L8 3z" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
...
function getVenueIcon(type: string | null, color: string) {
  ...
  if (lower.includes('bar') || lower.includes('brewery') || lower.includes('pub')) return <BarIcon color={color} />;
  if (lower.includes('restaurant') || lower.includes('mexican') || lower.includes('italian') || lower.includes('asian') || lower.includes('american')) return <FoodIcon color={color} />;
...
export const VenueMarker: React.FC<VenueMarkerProps> = ({ venue, isSelected, onPress, themeColors: tc }) => {
  ...
  return (
    ...
    >
      <View style={[styles.markerContainer, isSelected && styles.markerSelected]}>
        <View style={[styles.markerBubble, { backgroundColor: isSelected ? tc.primary : tc.cardBackground, borderColor: isSelected ? tc.primary : tc.border }]}>
        ...
        <View style={[styles.markerArrow, { borderTopColor: isSelected ? tc.primary : tc.cardBackground }]} />
      </View>
    </Marker>
  );
};
